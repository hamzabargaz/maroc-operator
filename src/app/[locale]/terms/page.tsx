...
export default function Privacy() {
  return (
    <div className=' w-full mx-auto max-w-4xl flex flex-col gap-4 px-10'>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to maroc operateur.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to maroc operateur, accessible from{" "}
            <a
              href='https://www.marocoperateur.com/'
              rel='external nofollow noopener'
              target='_blank'
            >
              https://www.marocoperateur.com/
            </a>
          </p>
        </li>
        <li>
      ...
      <p>
        ...
        USD if You haven&sbquo;t purchased anything through the Service.
      </p>
      <p>
      ...
      <p>
        ...
        each party&sbquo;s liability will be limited to the greatest extent
        permitted by law.
      </p>
      ...
      <p>
        ...
        company&sbquo;s provider makes any representation or warranty of any
      ...
      <p>
        ...
        party&sbquo;s ability to exercise such right or require such performance
      ...
      <p>
        ...
        efforts to provide at least 30 days&sbquo; notice prior to any new terms
      ...
      <ul>
        <li>
          <p>By email: contact@marocoperateur.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:{" "}
            <a
              href='https://www.marocoperateur.com/contact'
              rel='external nofollow noopener'
              target='_blank'
            >
              https://www.marocoperateur.com/contact
            </a>
          </p>
        </li>
      </ul>
